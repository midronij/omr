...
public:
   ...
   static const int32_t NumAllIlOps = TR::NumIlOps + NumVectorOperations*TR::NumVectorTypes;
   ...
   */
   static ILOpCode createVectorOpCode(VectorOperation operation, DataType resultVectorType)
      ...
      return (TR::ILOpCodes)(TR::NumIlOps + operation*TR::NumVectorTypes + (resultVectorType - TR::NumScalarTypes));
      }
   ...
   */
   bool isVectorOpCode() const { return _opCode >= TR::NumIlOps; }
   ...
   *     True if the opcode represents vector operation, false otherwise
   */
   static bool isVectorOpCode(ILOpCode op) { return op._opCode >= TR::NumIlOps; }
   ...
   */
   static bool isOMROpCode(ILOpCode op) { return op._opCode <= TR::LastOMROp || isVectorOpCode(op); }
   ...
   */
   VectorOperation getVectorOperation() const
      ...
      return (VectorOperation)((_opCode - TR::NumIlOps) / TR::NumVectorTypes);
      }
   ...
   */
   static VectorOperation getVectorOperation(ILOpCode op)
      ...
      return (VectorOperation)((op._opCode - TR::NumIlOps) / TR::NumVectorTypes);
      }
   ...
   */
   TR::DataType getVectorResultDataType() const
      ...
      return (TR::DataTypes)((_opCode - TR::NumIlOps) % TR::NumVectorTypes + TR::NumScalarTypes);
      }
   ...
   */
   static TR::DataType getVectorResultDataType(ILOpCode op)
      ...
      return (TR::DataTypes)((op._opCode - TR::NumIlOps) % TR::NumVectorTypes + TR::NumScalarTypes);
      }
   ...
   *     Index to OMR tables
   */
   int32_t getTableIndex() const { return isVectorOpCode() ? (TR::NumIlOps + getVectorOperation()) : _opCode; }
...
protected:
   ...
   static const int32_t opCodePropertiesSize = TR::NumIlOps + NumVectorOperations;
