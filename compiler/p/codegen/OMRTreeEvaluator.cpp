...
OMR::Power::TreeEvaluator::mAnyTrueEvaluator(TR::Node *node, TR::CodeGenerator *cg)
   ...
   TR::Register *maskReg = maskNode ? cg->evaluate(maskNode) : cg->allocateRegister(TR_VRF);
   ...
   generateTrg1Src2Instruction(cg, TR::InstOpCode::xxlnor, node, temp1, temp1, temp1);
