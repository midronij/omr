...
template <typename T> static
std::vector<std::tuple<T, T, int32_t>> test_mask_then_shift_values()
   {
   return TRTest::combine_flat(TRTest::combine(TRTest::const_values<T>(), test_masks<T>()), test_shifts<T>());
   }
...
template <typename T>
MaskThenShiftParamStruct<T> to_mask_then_shift_struct(std::tuple<std::tuple<T, T, int32_t>, std::tuple<std::string, T (*)(T, T, int32_t)>> param) {
    MaskThenShiftParamStruct<T> s;

    s.value = std::get<0>(std::get<0>(param));
    s.mask = std::get<1>(std::get<0>(param));
    s.shift = std::get<2>(std::get<0>(param));
...
template <typename T>
class MaskThenShiftArithmetic : public TRTest::OpCodeTest<T, T, T, int32_t> {};
...
INSTANTIATE_TEST_CASE_P(ShiftAndRotateTest, UInt64MaskThenShift, ::testing::Combine(
    ::testing::ValuesIn(static_cast< std::vector<std::tuple<uint64_t, uint64_t, int32_t>> (*) (void)>(test_mask_then_shift_values)()),
...
INSTANTIATE_TEST_CASE_P(ShiftAndRotateTest, Int64MaskThenShift, ::testing::Combine(
    ::testing::ValuesIn(static_cast< std::vector<std::tuple<int64_t, int64_t, int32_t>> (*) (void)>(test_mask_then_shift_values)()),
...
INSTANTIATE_TEST_CASE_P(ShiftAndRotateTest, UInt32MaskThenShift, ::testing::Combine(
    ::testing::ValuesIn(static_cast< std::vector<std::tuple<uint32_t, uint32_t, int32_t>> (*) (void)>(test_mask_then_shift_values)()),
...
INSTANTIATE_TEST_CASE_P(ShiftAndRotateTest, Int32MaskThenShift, ::testing::Combine(
    ::testing::ValuesIn(static_cast< std::vector<std::tuple<int32_t, int32_t, int32_t>> (*) (void)>(test_mask_then_shift_values)()),
...
INSTANTIATE_TEST_CASE_P(ShiftAndRotateTest, UInt16MaskThenShift, ::testing::Combine(
    ::testing::ValuesIn(static_cast< std::vector<std::tuple<uint16_t, uint16_t, int32_t>> (*) (void)>(test_mask_then_shift_values)()),
...
INSTANTIATE_TEST_CASE_P(ShiftAndRotateTest, Int16MaskThenShift, ::testing::Combine(
    ::testing::ValuesIn(static_cast< std::vector<std::tuple<int16_t, int16_t, int32_t>> (*) (void)>(test_mask_then_shift_values)()),
...
INSTANTIATE_TEST_CASE_P(ShiftAndRotateTest, UInt8MaskThenShift, ::testing::Combine(
    ::testing::ValuesIn(static_cast< std::vector<std::tuple<uint8_t, uint8_t, int32_t>> (*) (void)>(test_mask_then_shift_values)()),
...
INSTANTIATE_TEST_CASE_P(ShiftAndRotateTest, Int8MaskThenShift, ::testing::Combine(
    ::testing::ValuesIn(static_cast< std::vector<std::tuple<int8_t, int8_t, int32_t>> (*) (void)>(test_mask_then_shift_values)()),
